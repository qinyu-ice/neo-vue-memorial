...
export const emailRegister = (registerEmailData) => {
    return request.post('email/register', {
        email: registerEmailData.email,
        emailPassword: registerEmailData.emailPassword,
        code: registerEmailData.code
    })
}
...
export const passwordLogin = (passwordLoginData) => {
    return request.post('email/password-login', {
        email: passwordLoginData.email,
        emailPassword: passwordLoginData.emailPassword
    })
}
