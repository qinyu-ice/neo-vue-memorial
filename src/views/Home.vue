...
<template>
  ...
  <div class="page-container" style="margin-top: 20px; height: 400px;">
    ...
    <el-card style="width: 25%; margin-left: 20px;">
      ...
      <img
          :src="`https://restapi.amap.com/v3/staticmap?location=107.481186,31.218771&zoom=12&size=750*750&markers=mid,,B:107.481186,31.218771|mid,0xFFFF00,A:` + `107.484706,31.211239` + `&traffic=1&scale=1&key=43b4c8b855538aa8afb4f7a4e2f0be60`"
