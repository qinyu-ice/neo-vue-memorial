    ...
    <el-row>
      ...
      <el-card class="card-item" style="margin-left:29px;">
        ...
        <el-pagination class="pagination" v-model:current-page="pageNum1" :page-size="pageSize1" :total="total1"
                       layout="jumper,total,prev,pager,next" background
    ...
    <el-row style="margin-bottom: 20px;">
      <el-card class="card-item2">
        ...
        <div class="container">
          ...
          <div>
            ...
            <el-text
                style="font-size: 16px; margin-left: 10px; color: #303133;">扫码登录烈士寻亲政府公共服务平台，提供烈士寻亲线索，帮助烈士早日找到亲人。
            </el-text>
          </div>
        </div>
      </el-card>
      <el-card class="card-item2" style="margin-left:29px;">
        ...
        <el-text style="font-size: 15px; color: #303133;">
          ...
          欢迎联系今日头条“头条寻人”栏目（邮箱：xunren@toutiao.com）。
        </el-text>
      </el-card>
    </el-row>
  </div>
